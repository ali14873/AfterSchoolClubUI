...
//         start: '2024-04-22',
//         end: '2024-04-22',
//         description: 'Annual tech conference covering topics on software development, AI, and more.',
...
// const apiResponse= [
//         {
//             "id": "913461e8-9529-4bbc-98df-1a80aa9edb87",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
...
//         },
//         {
//             "id": "1032a479-df99-4a5c-8039-2757b4a0f2f1",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "ADDSESSSO",
//             "date": "2024-04-23",
//             "location": "ADDSESSSO",
//             "isRecurring": true,
//             "recurring": {
...
//         },
//         {
//             "id": "1d829aef-4029-4fc9-8534-3d8d5992da61",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "MEMBER",
//             "date": null,
//             "location": "MEMBER",
...
//         },
//         {
//             "id": "7cf75452-e636-41fc-91d0-49fe68f992b1",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
...
//         },
//         {
//             "id": "7feb0cb0-5d1e-4b2f-9dc6-4d42565f95f6",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "TSTER",
//             "date": "2024-04-23",
//             "location": "TSTER",
...
//         },
//         {
//             "id": "87c47208-99c9-49de-8fb0-6ccf3c3edaf1",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
...
//         },
//         {
//             "id": "bf083e25-d61b-412e-92ce-7ca43ffaf895",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "Addding Test",
//             "date": null,
//             "location": "Addding Test",
//             "isRecurring": true,
//             "recurring": {
//                 "repeat": "weekly",
//                 "interval": 8,
...
//         },
//         {
//             "id": "a1f1ed70-ec90-401d-a98d-93b14a1d1bc2",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "ADDINGCLUB",
//             "date": null,
//             "location": "ADDINGCLUB",
//             "isRecurring": true,
//             "recurring": {
...
//         },
//         {
//             "id": "8e3e5162-b500-4b26-adcf-9ce0065c71bc",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "NEWTESTING",
//             "date": null,
//             "location": "NEWTESTING",
//             "isRecurring": true,
//             "recurring": {
...
//         },
//         {
//             "id": "9bd1b4b8-6b46-4dce-989c-b3ef89134ae5",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "MEMBER",
//             "date": null,
//             "location": "MEMBER",
...
//         },
//         {
//             "id": "901de924-1a9f-4ad9-b1fd-d6b40e16c687",
//             "clubID": "e71eaf89-78dc-4099-b017-11c35437a1f0",
//             "description": "ADDINGCLUB",
//             "date": null,
//             "location": "ADDINGCLUB",
...
//         "day": "",
//         "interval": "3",
//         "start": "Tue Apr 02 2024 00:00:00 GMT+0500 (Pakistan Standard Time)",
//         "end": "Tue Apr 02 2024 00:00:00 GMT+0500 (Pakistan Standard Time)",
//         "startTime": "14:00:00",
//         "endTime": "14:00:00",
//         "weekDays": "MO,SU,TU,WE"
//     }
...
function EventCalendar() {
    ...
    const [typeofcalender, settype] = useState('month')
const [sizee, setsize] = useState(1)
const [apiResponse,setResponse]=useState();
const [myEvents, setMyEvents] = useState(apiResponse);
...
const fetchsession = async () => {
    try {
      const response = await axios.get(
        `https://afterschoolclub.azurewebsites.net/sessions/byClub/e71eaf89-78dc-4099-b017-11c35437a1f0`
      );
  
      console.log("This is Data",response);
  setResponse(response.data);
  setMyEvents(response.data)
      console.log("This is Api ",apiResponse);
    } catch (error) {
...
console.log("These are Events",myEvents);
...
const saveEvent = useCallback(() => {
    ...
    if (isEdit) {
        ...
        console.log("This is the New Custom Event",newEv);
    ...
    // close the popup
    setOpen(false);
}, [tempEvent, popupEventTitle, popupEventLocation, popupEventDescription, popupEventDate, popupEventAllDay, getCustomRule, isEdit, navigateTo, myEvents]);
...
// popup options
const headerText = useMemo(() => (isEdit ? 'Edit event' : 'Add New Club'), [isEdit]);
            ...
            handler: () => {
                if (recurringDelete) {
                    ...
                    if (editFromPopup) {
                        ...
                        tempEvent.location = popupEventLocation;
                    ...
                    console.log("This is the New Custom Event",newEventList);
...
const customWithNavButtons = useCallback(() => (
    <>
        <Button className='today'  variant="flat">Today</Button>

        <div className="md-custom-header-controls con flexx">
            <Button onClick={() => navigatePage(true)} icon="material-arrow-back" variant="flat" className="md-custom-header-button"></Button>

            <CalendarNav  className="md-custom-header-nav headerdate" />
        ...
        <div className="buttonsrounded">
        <Button className={view === 'week' ? 'weekly active' : 'weekly'} onClick={() => changeView('week')} variant="flat">Weekly</Button>
        <Button className={view === 'month' ? 'weekly active' : 'weekly'} onClick={() => changeView('month')} variant="flat">Monthly</Button>
        <Button className={view === 'year' ? 'weekly active' : 'weekly'} onClick={() => changeView('year')} variant="flat">Yearly</Button>
        <Button className={view === 'day' ? 'weekly last active' : 'weekly last'} onClick={() => changeView('day')} variant="flat">Day</Button>
    </div>
</div>
...
/>
        ...
        >
            <div className="mbsc-form-group">
                ...
                <Textarea placeholder='Description' label="Description" value={popupEventDescription} onChange={descriptionChange} />

                <Input placeholder='Location' label="Location" value={popupEventLocation} onChange={locationChange} />
