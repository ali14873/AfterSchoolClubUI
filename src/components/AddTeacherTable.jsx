...
import EditModalTeacher from "./EditModalTeacher";
...
const fetchTeachers = async () => {
    try {
        const response = await axios.get('https://afterschoolclub.azurewebsites.net/teacher/getAll');
  ...
  const handleDelete = async (id) => {
    ...
    try 
    {
      await axios.delete(`https://afterschoolclub.azurewebsites.net/teacher/delete/${id}`);
