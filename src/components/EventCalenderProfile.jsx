import {
  ...
  import { CalendarNav, CalendarToday, getJson } from "@mobiscroll/react";
    ...
    const fetchsession = async () => {
      try {
        const response = await axios.get(
          `https://afterschoolclub.azurewebsites.net/sessions/byClub/${1233}`
        );
  ...
  useEffect(()=>{
    ...
    const headerText = useMemo(
      () => (isEdit ? "Edit event" : "Add New Club"),
      [isEdit]
    );
    ...
    const customWithNavButtons = useCallback(
      () => (
        <>
          <div className="md-custom-header-controls mx-auto d-flex align-items-center">
            <Button
          ...
          <div className="mbsc-form-group">
            ...
            {isEdit && (
              <div className="mbsc-button-group">
                ...
                <Button
                  className="mbsc-button-block btn-primary"
                  color="primary"
                  variant="outline"
  
                  onClick={()=>{
                    handleBooking(tempEvent)
                  }}
  ...
  export default EventCalendarProfile;
